...
# checkov:skip=CKV2_AWS_5:Security Group is attached in EC2 module
...
# checkov:skip=CKV_AWS_24:Allow SSH for Lab purposes
...
# checkov:skip=CKV_AWS_382:Allow all egress for yum/apt updates in Lab
